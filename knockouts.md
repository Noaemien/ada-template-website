---
layout: default
title: The Road to the Grand Final
---
...
Let's have a closer look at the biggest upset of this stage:

![Match analysis](images/matchup_London_vs_China.png)

This is one of the most surprising results in the bracket: Seed 14 eliminating Seed 3.

At first glance, the **Global Score is extremely close** (London 50.79% vs China 49.21%), meaning the outcome is decided on very fine margins.  
...
Quarter-finals are where “random” underdogs usually get filtered out… 

On paper, **London (14)** has already overperformed by reaching this round. It then runs into **Japan (6)**, and Japan shuts the door. Let's look at this more closely!

![Match analysis](images/matchup_London_vs_Japan.png)

Against an opponent that we saw had strong versatility, Japan manages to match and even show a slight strength in that domain. Japan is even less popular than China was, yet it manages to overpower London's efficiency! A very close match that proves that London was not just here randomly.
...
Meanwhile, the real headline here is **South_Africa (5)** defeating **New_York_City (4)** to reach the semifinals.  
This is a minor upset (5 over 4), but the results show a devastating story for NYC.

![Match analysis](images/matchup_South_Africa_vs_NYC.png)

Based on the seeds, you would have imagined this matchup to be close.  
...
By the semi-finals, the bracket shows a classic pattern: the best seeds tend to regain control.
...
The domination is clear, and the USA just smashes its opponent, even if South Africa shows good resistance in Efficiency.

Then there’s the other matchup: **United_Kingdom (2) vs Japan (6)**.  
We saw Japan manage to shut down an underdog, but how will it fare against a truly strong opponent? This should be a close matchup, let's display the statistics!

![Match analysis](images/matchup_United_Kingdom_vs_Japan.png)

And these are the most dramatic results we've seen! The **United Kingdom** beats **Japan** here at a stunning **55.77% vs 44.23%**.
...
Japan hits a structural ceiling. It can outperform strong but less efficient hubs (like NYC), but once faced with a more balanced hub, its path ends.
...
<div class="change-page-button-wrapper">
  <a href="/ada-template-website/final" class="change-page-button">
    Go to next chapter : The Grand Final
  </a>
</div>