...
By the end of the repechage, the remaining contenders will go through the **Round of 16**, but this is the last chance for these contenders to survive in the competition.
...
Albert Einstein reminds everyone that the ideas that changed how we see the universe can be stronger than nations: he dominates his playoff.
...
- Group winners are assigned a **seed** based on their pre-tournament odds of winning (lowest volatility).

This ensures that the winner of the group stage gets a little advantage by normally facing a weaker opponent from the *loser bracket*. In other words, the better a hub performs early on, the more favorable its path becomes, but nothing is guaranteed.
...
It is time to discover the final table of the tournament!
...
There are also interesting and symbolic matchups. **United Kingdom (4) vs Periodic Table (13)** is an interesting matchup between geography and science, while **Japan (6) vs Russia (11)** is another clash of cultures.
